...
# Aumenta a frequência da música
pygame.mixer.pre_init(44100)

# Inicializa o pygame (necessário para o audio)
# E também inicializa as fontes para escrever
pygame.init()
pygame.font.init()
...
tela_largura = 800
tela_altura = 600
fundo_abertura = pygame.image.load('graficos/abertura.png')
...
# Primeiro loop (tela de abertura)
abertura = True
while abertura:
    # Desenha o fundo da abertura
    tela.blit(fundo_abertura, (0,0))

    # Escrever mensagem (pressione ENTER)
    fonte = pygame.font.SysFont("Arial", 90)
    label = fonte.render("Pressione ENTER" , 1, [0,0,0])
    # Posicionar no centro
    label_rect = label.get_rect()
    label_rect.center = (tela_largura / 2, (tela_altura / 2) + 60)
...
# Coloca a música para tocar com número de repetições
# igual a -1, que significa infinito
